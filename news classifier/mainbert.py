...
file_path = '/kaggle/input/newsds/News_Category_Dataset_v3.json'
...
model = DistilBertModel.from_pretrained("distilbert-base-uncased", num_labels=len(label_dict))
model.to(device)
...
# Save the model
model.save_pretrained("bertnews")
